create table cidade (id bigint not null auto_increment, nome_cidade varchar(255) not null, estado_id bigint, primary key (id)) engine=InnoDB;
create table cozinha (id bigint not null auto_increment, nome_cozinha varchar(60), primary key (id)) engine=InnoDB;
create table estado (id bigint not null auto_increment, nome_estado varchar(255) not null, sigla_estado varchar(255) not null, primary key (id)) engine=InnoDB;
...
create table grupo (id bigint not null, nome_grupo varchar(255) not null, primary key (id)) engine=InnoDB;
create table grupo_permissao (grupo_id bigint not null, permissao_id bigint not null) engine=InnoDB;
create table hibernate_sequence (next_val bigint) engine=InnoDB;
insert into hibernate_sequence values ( 1 );
create table permissao (id bigint not null auto_increment, descricao_permissao varchar(255), nome_permissao varchar(255) not null, primary key (id)) engine=InnoDB;
create table produto (id bigint not null auto_increment, ativo bit not null, descricao varchar(255) not null, nome_produto varchar(255) not null, preco decimal(19,2) not null, restaurante_id bigint, primary key (id)) engine=InnoDB;
create table restaurante (id bigint not null auto_increment, data_atualizacao datetime not null, data_cadastro datetime not null, endereco_bairro varchar(255), endereco_cep varchar(255), endereco_complemento varchar(255), endereco_logradouro varchar(255), endereco_numero varchar(255), nome_restaurante varchar(255) not null, taxa_frete decimal(19,2) not null, cozinha_id bigint, endereco_cidade_id bigint, primary key (id)) engine=InnoDB;
create table restaurante_forma_pagamento (restaurante_id bigint not null, forma_pagamento_id bigint not null) engine=InnoDB;
create table usuario (id bigint not null, data_cadastro datetime, email varchar(255) not null, nome_usuario varchar(255) not null, senha varchar(255) not null, primary key (id)) engine=InnoDB;
...
alter table usuario_grupo add constraint FK72g6qw962ks7t2o330y8cft77 foreign key (grupo_id) references permissao (id);
